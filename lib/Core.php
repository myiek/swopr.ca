...
/*********************************************************************************************/
	...
	function registerPOD($name,$description,$rewriteRules,$libOptions=null,$include=null,$settings=null) {
...
*********************************************************************************************/
	...
	function getAlerts($PARAMETERS=null,$sort="date DESC",$count=20,$offset=0) {
...
*********************************************************************************************/
	...
	function sanitizeInput($str) { 
		...
		$str = strip_tags($str,'<p><pre><blockquote><h1><h2><h3><h4><h5><h6><ol><ul><li><br><em><strong><i><u><b><strike><a><img><object><param><embed><div>');
		return $str;
