...
*********************************************************************************************/
		...
		function files($count=100,$offset=0) {		
			...
			if (!$this->FILES) { 
				$this->FILES = new Stack($this->POD,'file',array('groupId'=>'null','contentId'=>'null','userId'=>$this->get('id')),null,$count,$offset);
...
*************************************************************************************/
		...
		function comments() {		
			...
			if (!$this->COMMENTS) {
				$this->COMMENTS = $this->POD->getComments(array('profileId'=>$this->get('id')));
