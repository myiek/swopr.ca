	...
	$().ready( function() { 
		...
		$('textarea.tinymce').tinymce({
			...
			valid_elements: "p,pre,blockquote,h1,h2,h3,h4,h5,h6,ol,ul,li,br,em,strong,i,u,b,strike,a[href|target|title],img[src|width|height|alt|border|title|align|style],object[width|height|classid],param[name|value],embed[src|type|width|height|allowfullscreen|allowscriptaccess|cachebusting|bgcolor|quality|flashvars],div[class|href|style]",
			plugins:"paste",
